...
export default function ImportModalOgohlantirish({ fetchData }) {
    ...
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <DialogContent>
            <DialogContentText>
              Ogohlantirish xati yuborilgan abonentlarning hisob raqamlarini{" "}
              <a className="text-primary" onClick={onDownload}>
                na'muna
              </a>{" "}
              dagidek excel fayl ko'rinishida yuboring.
            </DialogContentText>
            <input
              type="file"
