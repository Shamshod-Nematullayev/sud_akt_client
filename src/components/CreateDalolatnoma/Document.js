    ...
    <>
      {documentType === "odam_soni" ? (
        ...
        <div id="print" ref={componentRef}>
          ...
          >
            Биз қуйидаги имзо чекувчилар, Самарқанд вилояти, Каттакургон тумани,{" "}
            {mahalla.name} МФЙ раиси{" "}
            {`${mahalla.mfy_rais_name?.split(" ")[1][0]}. ${
              mahalla.mfy_rais_name?.split(" ")[0]
            }`}{" "}
            , “АНВАРЖОН БИЗНЕС ИНВЕСТ” МЧЖ Каттақўрғон туман аҳоли назоратчиси{" "}
            {mahalla.biriktirilganNazoratchi?.inspector_name}, Абонентлар билан
            ишлаш бўлими бошлиғи Ш.Неъматуллаев мазкур далолатномани шу ҳақида
            туздик. МФЙ рўйхатини ўрганиш натижасида куйидаги абонент
          </p>
          ...
          {mahalla2 ? (
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div>___________</div>
              <div style={{ width: 200 }}>{`${
                mahalla2.mfy_rais_name?.split(" ")[1][0]
              }. ${mahalla2.mfy_rais_name?.split(" ")[0]}`}</div>
            </div>
          ) : (
            ""
          )}
          ...
          >
            Шуни ёзиб маълум қиламанки менинг {ikkilamchiKod} иккиламчи хисоб
            ракамимни ҳакикий {licshet} ҳисоб рақамимга далолатнома асосида
            иккиламчи хисоб-рақамимда тўловлар мавжуд бўлса, асосий
            ҳисоб-рақамга кўчириб, иккиламчи ҳисоб-рақамимни ўчириб беришингизни
            сурайман.
          </p>
          <p style={{ fontWeight: "bold", textAlign: "center" }}>
            "{date.getDate()}" {oylar[date.getMonth()]} {date.getFullYear()} йил
